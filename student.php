...
$STUD_FACULTY = $_POST['stud_faculty'];
	         ...
	         $sql = 'begin insert_new_stud(:c1,:c2,:c3,:c4,:c5,:c6,:c7);end;';
				...
				oci_bind_by_name($stid,':c2',$STUD_NAME);
				oci_bind_by_name($stid,':c3',$STUD_YEAR);
				oci_bind_by_name($stid,':c4',$STUD_COURSE);
				oci_bind_by_name($stid,':c5',$STUD_SESSION);
				oci_bind_by_name($stid,':c6',$STUD_GROUP);
				oci_bind_by_name($stid,':c7',$STUD_FACULTY);
				oci_execute($stid);
				//var_dump($sql);
				
             Echo"<script language = 'Javascript'>
					alert('Done added your student.')
					location.href = 'add_student.php'</script>";
