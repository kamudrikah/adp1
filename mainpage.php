  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form action="subjectUpdate.php" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            <label for="type_subject" name="type_subject" class="col-sm-2 control-label">Subject Type</label>
            <div class="col-sm-10">
